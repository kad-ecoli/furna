...
"cif2pdb input.cif chainID prefix\n"
"    extract structure of binding partner for chainID\n"
"\n"
"Input:\n"
"    input.cif                   - PDBx/mmCIF format biological assembly\n"
"    chainID                     - ID of receptor chain\n"
"\n"
"Ouput:\n"
//"    prefix.cif                  - simplified biological assembly\n"
"    prefix_{protein,rna,dna}_chainID_0.pdb - polymer binding partner\n"
"    prefix_res_chainID_[1-].pdb - regular ligand\n"
...
void make_vdw(map<string,double> &vdw_dict)
{
    ...
    vdw_dict["Au"]=1.66; vdw_dict["B" ]=2.00; vdw_dict[" B"]=2.00;
    vdw_dict["BA"]=2.00; vdw_dict["Ba"]=2.00; vdw_dict["BE"]=2.00; 
    vdw_dict["Be"]=2.00; vdw_dict["BH"]=2.00; vdw_dict["Bh"]=2.00; 
    vdw_dict["BI"]=2.00; vdw_dict["Bi"]=2.00; vdw_dict["BK"]=2.00; 
    vdw_dict["Bk"]=2.00; vdw_dict["Br"]=1.85; vdw_dict["BR"]=1.85;
    vdw_dict["C" ]=1.70; vdw_dict[" C"]=1.70; vdw_dict["CA"]=2.00;
    vdw_dict["Ca"]=2.00; vdw_dict["CD"]=1.58; vdw_dict["Cd"]=1.58;
    vdw_dict["CE"]=2.00; vdw_dict["Ce"]=2.00; vdw_dict["CF"]=2.00;
    vdw_dict["Cf"]=2.00; vdw_dict["CL"]=1.75; vdw_dict["Cl"]=1.75;
    vdw_dict["CM"]=2.00; vdw_dict["Cm"]=2.00; vdw_dict["CO"]=2.00;
    vdw_dict["Co"]=2.00; vdw_dict["CR"]=2.00; vdw_dict["Cr"]=2.00;
    vdw_dict["CS"]=2.00; vdw_dict["Cs"]=2.00; vdw_dict["CU"]=1.40;
    vdw_dict["Cu"]=1.40; vdw_dict["DB"]=2.00; vdw_dict["Db"]=2.00;
    vdw_dict["DS"]=2.00; vdw_dict["Ds"]=2.00; vdw_dict["DY"]=2.00;
    vdw_dict["Dy"]=2.00; vdw_dict["ER"]=2.00; vdw_dict["Er"]=2.00;
    vdw_dict["ES"]=2.00; vdw_dict["Es"]=2.00; vdw_dict["EU"]=2.00;
    vdw_dict["Eu"]=2.00; vdw_dict["F" ]=1.47; vdw_dict[" F"]=1.47;
    ...
    vdw_dict[" H"]=1.09; vdw_dict["GD"]=2.00; vdw_dict["Gd"]=2.00;
    vdw_dict["GE"]=2.00; vdw_dict["Ge"]=2.00; vdw_dict["HE"]=1.40; 
    vdw_dict["He"]=1.40; vdw_dict["HF"]=2.00; vdw_dict["Hf"]=2.00; 
    vdw_dict["HG"]=1.55; vdw_dict["Hg"]=1.55; vdw_dict["HO"]=2.00; 
    vdw_dict["Ho"]=2.00; vdw_dict["HS"]=2.00; vdw_dict["Hs"]=2.00;
    vdw_dict["I" ]=1.98; vdw_dict[" I"]=1.98; vdw_dict["K" ]=2.75; 
    ...
    vdw_dict["Mt"]=2.00; vdw_dict["N" ]=1.55; vdw_dict[" N"]=1.55; 
    vdw_dict["O" ]=1.52; vdw_dict[" O"]=1.52; vdw_dict["NA"]=2.27;
    vdw_dict["Na"]=2.27; vdw_dict["NB"]=2.00; vdw_dict["Nb"]=2.00;
    vdw_dict["ND"]=2.00; vdw_dict["Nd"]=2.00; vdw_dict["NE"]=1.54;
    vdw_dict["Ne"]=1.54; vdw_dict["NI"]=1.63; vdw_dict["Ni"]=1.63;
    vdw_dict["NO"]=2.00; vdw_dict["No"]=2.00; vdw_dict["NP"]=2.00;
    vdw_dict["Np"]=2.00; vdw_dict["OS"]=2.00; vdw_dict["Os"]=2.00;
    vdw_dict["P" ]=1.80; vdw_dict[" P"]=1.80; vdw_dict["S" ]=1.80;
    vdw_dict[" S"]=1.80; vdw_dict["PA"]=2.00; vdw_dict["Pa"]=2.00; 
    vdw_dict["PB"]=2.02; vdw_dict["Pb"]=2.02; vdw_dict["PD"]=1.63; 
    vdw_dict["Pd"]=1.63; vdw_dict["PM"]=2.00; vdw_dict["Pm"]=2.00; 
    vdw_dict["PO"]=2.00; vdw_dict["Po"]=2.00; vdw_dict["PR"]=2.00; 
    vdw_dict["Pr"]=2.00; vdw_dict["PT"]=1.72; vdw_dict["Pt"]=1.72; 
    vdw_dict["PU"]=2.00; vdw_dict["Pu"]=2.00; vdw_dict["RA"]=2.00; 
    vdw_dict["Ra"]=2.00; vdw_dict["RB"]=2.00; vdw_dict["Rb"]=2.00; 
    vdw_dict["RE"]=2.00; vdw_dict["Re"]=2.00; vdw_dict["RF"]=2.00; 
    vdw_dict["Rf"]=2.00; vdw_dict["RH"]=2.00; vdw_dict["Rh"]=2.00; 
    vdw_dict["RN"]=2.00; vdw_dict["Rn"]=2.00; vdw_dict["RU"]=2.00; 
    vdw_dict["Ru"]=2.00; vdw_dict["SB"]=2.00; vdw_dict["Sb"]=2.00; 
    vdw_dict["SC"]=2.00; vdw_dict["Sc"]=2.00; vdw_dict["SE"]=1.90; 
    vdw_dict["Se"]=1.90; vdw_dict["SG"]=2.00; vdw_dict["Sg"]=2.00; 
    vdw_dict["SI"]=2.10; vdw_dict["Si"]=2.10; vdw_dict["SM"]=2.00; 
    vdw_dict["Sm"]=2.00; vdw_dict["SN"]=2.17; vdw_dict["Sn"]=2.17; 
    vdw_dict["SR"]=2.00; vdw_dict["Sr"]=2.00; vdw_dict["TA"]=2.00; 
    vdw_dict["Ta"]=2.00; vdw_dict["TB"]=2.00; vdw_dict["Tb"]=2.00; 
    vdw_dict["TC"]=2.00; vdw_dict["Tc"]=2.00; vdw_dict["TE"]=2.06; 
    vdw_dict["Te"]=2.06; vdw_dict["TH"]=2.00; vdw_dict["Th"]=2.00; 
    vdw_dict["TI"]=2.00; vdw_dict["Ti"]=2.00; vdw_dict["TL"]=1.96; 
    vdw_dict["Tl"]=1.96; vdw_dict["TM"]=2.00; vdw_dict["U" ]=1.86;
    vdw_dict[" U"]=1.86; vdw_dict["V" ]=2.00; vdw_dict[" V"]=2.00;
    vdw_dict["W" ]=2.00; vdw_dict[" W"]=2.00; vdw_dict["XE"]=2.16; 
    vdw_dict["Xe"]=2.16; vdw_dict["YB"]=2.00; vdw_dict["Yb"]=2.00; 
    vdw_dict["ZN"]=1.39; vdw_dict["Zn"]=1.39; vdw_dict["ZR"]=2.00; 
    vdw_dict["Zr"]=2.00; vdw_dict["Y" ]=2.00; vdw_dict[" Y"]=2.00;
    vdw_dict["D" ]=1.00; vdw_dict[" D"]=1.00; vdw_dict["XD"]=1.09;
}
...
size_t getContact(const vector<vector<double> >&ligand_vec, 
    ...
    ModelUnit &pep,const string&recChainID,
    ...
    string &metadata_txt)
{
    ...
    {
        if (recChainID!=pep.chains[c].asym_id) continue;
...
int cif2pdb(const string &infile, const string &recChainID, string &prefix)
{
    ...
    for (l=0;l<lines.size();l++)
    {
        ...
        else if (line_vec.size()==1 && line_vec[0]=="#")
        {
            ...
            loop_=true;
        else if (prefix.size()==0 && l==0 && StartsWith(line,"data_"))
            prefix=Lower(line.substr(5));
        else if (prefix.size()==0 && line_vec.size()>1 && line_vec[0]=="_entry.id")
            prefix=Lower(line_vec[1]);
            ...
            _atom_site.count("Cartn_y") && _atom_site.count("Cartn_z"))
        {
            ...
            _atom_site_id++;
            //fout_buf<<group_PDB<<' '<<_atom_site_id<<' '
                //<<atom_id<<' '<<comp_id<<' '<<asym_id<<' '<<seq_id<<' '
    ...
    /* write simplified mmCIF */
    ofstream fout;
    string filename;
    //filename=prefix+".cif";
    //fout.open(filename.c_str());
    //fout_buf.flush();
    //fout<<fout_buf.str()<<"# "<<endl;
    //fout.close();
    ...
    for (c=0;c<pep.chains.size();c++)
    {
        ...
        if (recChainIdx<0 && asym_id==recChainID) recChainIdx=c;
    }
    if (recChainIdx<0)
    {
        cerr<<"ERROR! cannot find chain"<<recChainID<<endl;
        return -1;
    }
    else
    ...
    vector<pair<string,string>> polymerligand_vec;
...
79 - 80        LString(2)    charge       Charge  on the atom.
    ...
    */
    ...
    for (c0=0;c0<polymerligand_vec.size();c0++)
    {
        asym_id=polymerligand_vec[c0].first;
        comp_id=polymerligand_vec[c0].second;
    ...
    for (c=0;c<pep.chains.size();c++)
    {
        ...
        for (r=0;r<pep.chains[c].residues.size();r++)
        {
            ...
            resSeq=buf.str().substr(0,5);
            buf.str(string());
            filename=prefix+"_"+comp_id+"_"+asym_id;
            ...
            if (getContact(ligand_vec, asym_id, comp_id,
                ligand_dup_map[filename], pep, recChainID, vdw_dict, 
                resSeq_buf.str(), metadata_txt))
            {
    ...
    {
        line="tar -czf "+prefix+".tar.gz "+
             Join(" ",receptor_filename_vec)+" "+
             Join(" ",ligand_filename_vec);
        i=system(line.c_str());
        ifstream fp((prefix+".tar.gz").c_str());
        if (fp.good())
        {
            line="del ";
#if defined(REDI_PSTREAM_H_SEEN)
...
int main(int argc,char **argv)
{
    ...
    if (recChainID.size()==0)
    {
        cerr<<docstring;
        return 1;
    }

    cif2pdb(infile,recChainID,prefix);

    /* clean up */
    string ().swap(infile);
    string ().swap(recChainID);
    string ().swap(prefix);
    return 0;
}
