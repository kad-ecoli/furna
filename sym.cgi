...
<tr><td><a href=search.cgi?lig3=peptide>peptide</a></td><td>Short amino acid chain with &lt;30 residues.</td></tr>
<tr><td><a href=search.cgi?lig3=rna>rna</a></td><td>RNA chain.</td></tr>
<tr><td><a href=search.cgi?lig3=dna>dna</a></td><td>DNA chain.</td></tr>
<tr><td><a href=search.cgi?lig3=metal>metal</a></td><td>Metal ion</td></tr>
<tr><td><a href=search.cgi?lig3=regular>regular</a></td><td>Small molecule other than a metal ion.</td></tr>
</table>
''')
elif lig3:
    txt_table='''
...
'''
    ...
    for line in fp.read().splitlines():
        ...
        if lig3 in freq_dict and freq_dict[lig3]!='0':
            freq='<a href="search.cgi?lig3=%s" target=_blank>%s</a>'%(lig3,freq_dict[lig3])
...
<tr><td><strong>Number of entries in FURNA: </strong></td><td>$freq</td></tr>
...
<tr BGCOLOR="#DEDEDE"><td><strong>Name:</strong></td><td>$name</td></tr>
      '''.replace("$ccd",lig3
        ...
        print("View %s at the <a href=https://rcsb.org/ligand/%s target=_blank>PDB</a> and <a href=search.cgi?lig3=%s>FURNA</a> database</ul></p>"%(
            lig3,lig3,lig3))
    fp.close()
